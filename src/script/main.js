fetch("https://691ac0762d8d78557570025b.mockapi.io/api/posts/posts")
  .then((response) => {
    if (!response.ok) {
                ...
                <div class="product-item__img" style="background-image: url(${
                  product?.imageURL
                    ...
                    <div class="product-item__active  ">
                        ...
                        <span class="product-item__sell">Đã bán ${
                          product?.countSell > 1000 ? "1k+" : product?.countSell
                        } </span>
                        </div>
                        <div class="product-item__ogirin">
                            <span class="product-item__ogirin-brand">${
                              product?.brandName
                            } </span>
                            <span class="product-item__ogirin-name">${
                              product?.countryName
                            }</span>
                        </div>
                        ${
                        ...
                        <span class="product-item__sale-percent">${
                          product?.countSell
                        }%</span>
                </div>
            </a>
